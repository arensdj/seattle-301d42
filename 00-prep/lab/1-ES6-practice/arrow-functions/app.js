...
console.log(joe);
// Trying to refactor the Student object constructor causes the code to break.  The arrow functions don't bind with 'this'.  The context of the 'this' bubbles up to the global window object, which is the next nearest enclosing scope.
